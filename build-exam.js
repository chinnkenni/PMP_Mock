...
function renderQuestion(){
  ...
  opts.forEach(function(opt){
    ...
    btn.className=cls;
    if(!reviewMode)btn.onclick=(function(l){return function(){selectOption(l)};})(opt.letter);
    ...
    circ.className=lc;circ.textContent=opt.letter;

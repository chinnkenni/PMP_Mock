...
var examFinished=false, reviewMode=false, shuffledOptionsCache=null, frozenTimers=null;
...
function stopQuestionTimer(){
  if(!reviewMode && currentIndex>=0 && lastQuestionTime>0){
...
function submitExam(){
  ...
  frozenTimers={};for(var fi=0;fi<examQuestions.length;fi++){frozenTimers[fi]=questionTimers[fi]||0;}var totalMs=0;for(var ti=0;ti<examQuestions.length;ti++){totalMs+=(frozenTimers[ti]||0);}var elapsed=Math.round(totalMs/1000),em=Math.floor(elapsed/60),es=elapsed%60;
